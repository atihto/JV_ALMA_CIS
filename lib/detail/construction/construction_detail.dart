...
class ConstructionDetail extends StatelessWidget {
          ...
          children: [
            ...
            Padding(
              ...
              child: ConstrainedBox(
                ...
                child: _buildContentLayout(context, screenWidth, isMobile, isTablet),
              ),
            ),
            Container(
              decoration: const BoxDecoration(
  ...
  Widget _buildContentLayout(BuildContext context, double screenWidth, bool isMobile, bool isTablet) {
    return Column(
  ...
  Widget _buildConstructionContent(BuildContext context, double screenWidth, bool isMobile) {
    ...
    Future<void> launchUrl(String url) async {
      debugPrint('ConstructionDetail: Launching URL $url');
      if (await canLaunch(url)) {
        await launch(url);
      } else {
        debugPrint('ConstructionDetail: Could not launch $url');
      }
    }
...
class _ProjectCard extends StatelessWidget {
  ...
  bool _shouldCenterImage(Map<String, dynamic> project) {
    return (project['imagePaths'] as List<String>).length == 1 &&
        (project['title'] == 'United States Embassy - Medical Research Unit Renov, Kisumu' ||
         project['title'] == 'Italian Amb. Residence Renov, Nairobi' ||
         project['title'] == 'Swedish Amb. Residence Renov, Nairobi');
  }
}